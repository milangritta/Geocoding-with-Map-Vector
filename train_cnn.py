...
nec = Conv2D(20, (2, 2), activation="relu", input_shape=(1, 180 / GRID_SIZE, 360 / GRID_SIZE), data_format="channels_first")(near_entities_coord)
nec = MaxPooling2D(data_format="channels_first")(nec)
nec = Flatten()(nec)
nec = Dropout(0.3)(nec)

far_entities_coord = Input(shape=(1, 180 / GRID_SIZE, 360 / GRID_SIZE))
fec = Conv2D(20, (2, 2), activation="relu", input_shape=(1, 180 / GRID_SIZE, 360 / GRID_SIZE), data_format="channels_first")(far_entities_coord)
fec = MaxPooling2D(data_format="channels_first")(fec)
fec = Flatten()(fec)
fec = Dropout(0.3)(fec)

target_coord = Input(shape=(1, 180 / GRID_SIZE, 360 / GRID_SIZE))
tc = Conv2D(20, (2, 2), activation="relu", input_shape=(1, 180 / GRID_SIZE, 360 / GRID_SIZE), data_format="channels_first")(target_coord)
